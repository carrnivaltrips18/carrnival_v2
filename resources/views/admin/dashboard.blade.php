                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="account.logout" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Hello,{{Auth::guard('admin')->name}}</a>
